...
var myChart = new Chart(ctx, {
    ...
    datasets: [{ 
        ...
        data: [10.25, 7.40, 11.64, 17.08, 23.12, 30.60, 37.81, 41.28],
        label: "Ethereum",
        borderColor: "#8e5ea2",
        fill: false
      }, { 
        ...
        data: [67.61, 67.61, 91.61, 109.61, 133.61, 169.61, 196.61, 226.61],
        label: "Total Cost",
        borderColor: "#000000",
        fill: false
      }, { 
        data: [67.61, 60.50, 86.98, 104.33, 122.76, 145.28, 165.22, 167.27],
        label: "Total Value",
        borderColor: "#ff0000",
        fill: false
      }, { 
